  ...
  return (
    <div className="max-w-[1000px]">
      <div className="grid space-y-5 sm:space-y-0 sm:flex sm:items-center sm:justify-between sm:px-4 mt-10">
        <div className="bg-white p-2 py-3 shadow-xl rounded-2xl flex items-center md:scale-[120%]">
        ...
        >
          <AiOutlinePlus className="text-gray-100 bg-blue-600 border border-blue-500 rounded-lg p-1 w-7 h-7" />
          <h3 className="ml-2 text-sm">add new user</h3>
        </button>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-3 mt-20 sm:scale-[110%] sm:justify-items-center ">
